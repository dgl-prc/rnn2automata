from  baseline.bl2.icml2018_dfa.Quantisations import SVMDecisionTreeQuantisation
from  baseline.bl2.icml2018_dfa.WhiteboxRNNCounterexampleGenerator import WhiteboxRNNCounterexampleGenerator
...
class Teacher:
    ...
    def update_words(self, words):
        ...
        words = set(
            words) - seen  # need this to avoid answering same thing twice, which may happen a lot now with optimistic querying...
